package com.br.calculadora_simples

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import com.br.calculadora_simples.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apagar.setOnClickListener {
            calculo.text = calculo.text.dropLast(1) //dropLast apaga o ultimo caractere
        }
